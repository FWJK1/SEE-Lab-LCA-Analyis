...
class NodeFilter:
    ...
    def apply_filters(self, filter_config):
        ...
        # Define a mapping of filter names to vectorized functions
        vectorized_filters = {
    ...
    def filter_by_in_degree(self, row, min_in_degree):
        return row['in_degree'] >= min_in_degree
        
    def filter_by_out_degree(self, row, min_out_degree):
        return row['out_degree'] >= min_out_degree 